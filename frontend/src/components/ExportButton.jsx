  ...
  return (
    <div className="relative">
      ...
      >
        {exporting ? (
          <>
            <div className="w-4 h-4 border-2 border-gray-200 border-t-gray-300 rounded-full animate-spin" />
            Exportando...
          </>
        ) : (
          <>
        ...
        <>
          ...
          <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 z-20 overflow-hidden">
            ...
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-3 hover:bg-gray-100 transition-colors text-left border-t border-gray-200"
            >
              <FileText className="w-5 h-5 text-blue-400" />
              <div>
                <p className="text-sm font-medium text-gray-800">CSV</p>
