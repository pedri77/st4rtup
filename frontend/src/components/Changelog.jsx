...
export default function Changelog() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-40 w-80 bg-gray-900 border border-cyan-500/30 rounded-xl shadow-2xl overflow-hidden">
      <div className="bg-cyan-500/10 px-4 py-2 flex items-center justify-between">
        ...
        <button onClick={dismiss} className="text-gray-500 hover:text-white"><X className="w-4 h-4" /></button>
      </div>
      ...
      <div className="px-4 pb-3">
        <button onClick={dismiss} className="w-full text-xs text-center text-gray-500 hover:text-gray-300">Entendido</button>
      </div>
    </div>
  )
}
