          ...
          <div style={{ flex: '1 1 500px' }}>
            ...
            <FadeIn delay={0.2}>
              <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
                ...
                <Link to="/quiz" onClick={() => window.umami?.track('hero_cta_click', { variant: 'quiz' })} style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "14px 28px", background: "linear-gradient(135deg, #1E6FD9, #8B5CF6)", color: "white", borderRadius: 12, fontSize: 15, fontWeight: 700, textDecoration: "none", boxShadow: "0 4px 14px rgba(139,92,246,0.4)", transition: "transform 0.2s" }} onMouseEnter={e => e.currentTarget.style.transform = 'scale(1.03)'} onMouseLeave={e => e.currentTarget.style.transform = 'scale(1)'}>{lang === 'en' ? 'Discover your ideal plan' : 'Descubre tu plan ideal'} <ArrowRight size={16} /></Link>
              </div>
            </FadeIn>
          </div>
          <FadeIn delay={0.3}>
