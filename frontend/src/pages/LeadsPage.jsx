    ...
    <div className="-m-4 md:-m-8 p-4 md:p-8 min-h-full" style={{ backgroundColor: T.bg }}>
      ...
      <>
        ...
        style={{ backgroundColor: T.card, border: `1px solid ${T.border}` }}>
            ...
            className="p-1.5 transition-colors disabled:opacity-30" style={{ color: T.fgMuted }} aria-label="Anterior">
                  <ChevronLeft className="w-4 h-4" />
                </button>
                {[...Array(Math.min(totalPages, 7))].map((_, i) => {
              let p;
              if (totalPages <= 7) {p = i + 1;} else
              if (page <= 4) {p = i + 1;} else
              if (page >= totalPages - 3) {p = totalPages - 6 + i;} else
              {p = page - 3 + i;}
              return (
            ...
            className="p-1.5 transition-colors disabled:opacity-30" style={{ color: T.fgMuted }} aria-label="Siguiente">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                style={inputStyle} placeholder="CTO, CEO" />
              </div>
              <div>
