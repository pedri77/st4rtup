...
function APITab() {
  ...
  const integrations = [
    { name: 'Google Drive', letter: 'GD', color: 'hsl(210,70%,55%)', configKey: 'gdrive_config', href: '/app/integrations' },
    { name: 'Google Calendar', letter: 'GC', color: T.cyan, configKey: 'gcalendar_config', href: '/app/integrations' },
    { name: 'Google Forms', letter: 'GF', color: T.success, configKey: 'google_forms_config', href: '/app/integrations' },
    { name: 'Notion', letter: 'N', color: T.fgMuted, configKey: 'notion_config', href: '/app/integrations' },
    { name: 'HubSpot', letter: 'HS', color: 'hsl(25,75%,50%)', configKey: 'hubspot_config', href: '/app/integrations' },
    { name: 'Telegram', letter: 'TG', color: '#0088CC', configKey: 'telegram_config', href: '/app/alert-channels' },
    { name: 'Slack', letter: 'SL', color: '#E01E5A', configKey: 'slack_config', href: '/app/alert-channels' },
    { name: 'WhatsApp', letter: 'WA', color: '#25D366', configKey: 'whatsapp_config', href: '/app/alert-channels' },
    { name: 'Teams', letter: 'MS', color: '#6264A7', configKey: 'teams_config', href: '/app/alert-channels' },
    { name: 'Apollo.io', letter: 'AP', color: T.purple, configKey: 'apollo_config', href: '/app/integrations' },
    { name: 'Hunter.io', letter: 'HU', color: T.warning, configKey: 'hunter_config', href: '/app/integrations' },
    { name: 'Resend', letter: 'RE', color: T.cyan, configKey: 'email_config', href: '/app/settings' },
    { name: 'n8n', letter: 'n8', color: T.warning, configKey: 'n8n_config', href: '/app/integrations' },
    { name: 'Stripe', letter: 'ST', color: T.purple, configKey: 'stripe_config', href: '/app/integrations' },
    { name: 'PandaDoc', letter: 'PD', color: T.success, configKey: 'pandadoc_config', href: '/app/integrations' },
    { name: 'Calendly', letter: 'CL', color: T.cyan, configKey: 'calendly_config', href: '/app/integrations' },
    { name: 'LinkedIn', letter: 'LI', color: '#0A66C2', configKey: 'linkedin_config', href: '/app/integrations' },
    { name: 'Clearbit', letter: 'CB', color: 'hsl(210,70%,55%)', configKey: 'clearbit_config', href: '/app/integrations' },
    { name: 'PostHog', letter: 'PH', color: T.warning, configKey: 'general_config', href: '/app/integrations' },
  ]
