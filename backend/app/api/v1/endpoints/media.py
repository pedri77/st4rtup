...
async def seed_ad_campaigns(
    ...
    defaults = [
        {"name": "LinkedIn Ads — CEOs Enterprise", "platform": "linkedin_ads", "objective": "lead_gen",
         "target_audience": "CEOs, CTOs, DPOs en España · Empresa >50 empleados · Sector regulado",
         "placement": "Feed + Sponsored InMail", "targeting": "Job Title: CEO, CTO, DPO · Location: Spain · Company Size: 51-1000",
        ...
        {"name": "LinkedIn Ads — NIS2/DORA Awareness", "platform": "linkedin_ads", "objective": "brand_awareness",
         "target_audience": "Decision makers tecnología Europa · Banca, Energía, Salud",
        ...
        {"name": "Google Ads SEM — Keywords ENS NIS2", "platform": "google_ads", "objective": "lead_gen",
         "target_audience": "Búsquedas: 'cumplimiento ENS', 'plataforma NIS2', 'growth tecnología España'",
         "placement": "Search Network", "targeting": "Keywords: ENS alto, NIS2 software, growth tecnología, DORA compliance",
        ...
        {"name": "YouTube Ads — Webinar NIS2/DORA", "platform": "youtube_ads", "objective": "conversions",
         "target_audience": "Profesionales tecnología · España · Intereses: compliance, growth",
